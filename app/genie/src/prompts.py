opcoes = [
    "/chain: Irá trocar a chain para a chain desejada, é preciso passar o numero da Chain desejada",
...
chains = [
    "Chain de piada: Essa Chain irá fazer uma piada sobre qualquer assunto perguntado",
